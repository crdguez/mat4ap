...
\noaddpoints % to omit double points count
\begin{parts}
\part[0.5] ¿Cuánto tiempo tardó la pelota en caer al suelo?
\part[0.5] Indica la altura máxima que alcanza y en qué momento.
\part[0.5] ¿Durante cuánto tiempo la altura es superior a 3 m?
\part[0.5] Describe el crecimiento y el decrecimiento de la función y explica su significado dentro del contexto del problema.
\end{parts}
